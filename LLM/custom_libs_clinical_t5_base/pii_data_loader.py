...
class PIIDataLoader:
	...
	def __init__(self, train_texts=None, train_labels=None, valid_texts=None, valid_labels=None, test_texts=None, test_labels=None, tokenizer_name='hossboll/clinical-t5', batch_size=4):
	...
	def tokenize_data(self, texts):
		...
		return self.tokenizer(texts, truncation=True, padding=True, return_tensors="pt", max_length=256)#, max_length=64)
